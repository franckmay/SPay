 ...
 */
public class PubAdapter1 extends RecyclerView.Adapter<PuHolder1>  {
    Context c;
    ...
    public PubAdapter1(Context c) {
        this.c = c;
        //this.myDb = new DatabaseHelper(c);
    }

    @Override
    public PuHolder1 onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_pub_grand, parent, false);
        final PuHolder1 holder = new PuHolder1(v);
    ...
    @Override
    public void onBindViewHolder(final PuHolder1 holder, int position) {
